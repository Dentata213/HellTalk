...
<body class="color-theme-blue">
	...
	<form action="<c:url value="/member/register.do"/>" class="joinForm" method="post">
	  <h1>HellTalk에 오신것을 환영합니다.</h1>
	  <h4 class="text-grey-500">혹은 이미 계정이 있으신가요?? <a href="<c:url value="/member/Login.do"/>" class="fw-700 ms-1">로그인하러 가기</a></h4> 
      ...
      <div class="textForm">
        <input name="u_pwd" type="password" class="pw" placeholder="비밀번호 (비밀번호는 영문자와 숫자 그리고 특수문자가 포함되어야 하며 8자 이상)">
      </div>
      <div class="textForm">
      ...
      <div class="textForm">
        <input name="u_height" type="number" class="height" placeholder="신장 (단위:cm)">
      </div>
      <div class="textForm">
        <input name="u_weight" type="number" class="weight" placeholder="몸무게 (단위:kg)">
      </div>
