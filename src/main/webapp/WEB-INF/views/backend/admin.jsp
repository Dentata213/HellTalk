                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2" style="height: 83vh; width: 200px">
                        <ul class="mb-1 top-content">
                            ...
                            <li><a href="javascript:adminQnA();" class="nav-content-bttn open-font"><i class="feather-help-circle" style="color:black"></i>&nbsp;&nbsp;<span>Q&A</span></a></li>    
                        </ul>
                    </div>
                </div>
            </div>
