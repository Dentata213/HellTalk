...
<div class="container">
	...
	<div class="text-center">
		<c:if test="${sessionScope.id==record.id }" var="isWriter">
			<a href="<c:url value="/qna/Edit.do?no=${record.q_no}"/>"
			class="btn btn-success">수정</a> 
			<a
			href="javascript:isDelete(${record.q_no})" class="btn btn-success">삭제</a>
		</c:if>
		
		<a
			href="<c:url value="/qna/List.do"/>"
