								            ...
								            <div class="modal-content">
								                ...
								                <div class="modal-body">
								                    <div class="form-group">
								                        <label for="taskId" class="col-form-label">title</label> <input type="text" class="form-control"
								                            id="caldtitle" name="caldtitle">
								                        ...
								                        <label for="taskId" class="col-form-label">날짜</label> <input type="date" class="form-control"
								                            id="caldstartdate" name="caldstartdate">
								                    </div>
								                    <div class="row">
								                        <div class="col-xs-12">
								                ...
								                <div class="modal-footer">
								                    ...
								                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="addModalClose">닫기</button>
								                </div>
								    ...
								    <div class="modal fade" id="calendarModalView" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
								        ...
								        <div class="modal-dialog" role="document">
								            <div class="modal-content">
								                ...
								                <div class="modal-body">
								                    <div class="form-group">
								                        <input type="hidden" class="form-control" id="viewno" name="viewno" /> <label for="taskId"
								                            class="col-form-label">title</label>
								                        <input type="text" class="form-control" id="viewtitle" name="viewtitle" disabled /> <label
								                            for="taskId" class="col-form-label">내용</label>
								                        <textarea class="form-control" rows="10" id="viewcontent" name="viewcontent"
								                            disabled></textarea>
								                        <label for="taskId" class="col-form-label">날짜</label> <input type="date" class="form-control"
								                            id="viewdate" name="viewdate" disabled>
								                    </div>
								
								                    <div class="row">
								                        <div class="col-xs-12">
								                            <label class="col-xs-4" for="color" style="margin-left: 20px;" id="editecolortitle"
								                                hidden>색상</label> <select class="inputModal" name="editecaldcolor" id="editecaldcolor"
								                                hidden>
								                                <option value="#D25565" style="color: #D25565;">빨간색</option>
								                                <option value="#9775fa" style="color: #9775fa;">보라색</option>
								                                <option value="#ffa94d" style="color: #ffa94d;">주황색</option>
								                ...
								                <div class="modal-footer">
								                    ...
								                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="caldelete">삭제</button>
								                    <button type="button" class="btn btn-warning" data-dismiss="modal" id="viewModalClose">닫기</button>
								                </div>
