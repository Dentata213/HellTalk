<%@page import="com.helltalk.springapp.service.CalDto"%>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
	...
	<c:forEach var="cal2" items="${calendarList2}" varStatus="loop"> 			
	  	{
          title:'${cal2.title}',
          start:'${cal2.startDate}T12:00',
          end:'${cal2.endDate}T12:00',
          constraint: 'availableForMeeting', // defined below
          color:'${cal2.color}' //'#257e4a'
        },
        </c:forEach>   
        {
        title:'테스트',
