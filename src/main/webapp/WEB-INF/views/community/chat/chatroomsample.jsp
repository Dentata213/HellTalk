                                ...
                                <ul class="notification-box">
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3 bg-lightblue theme-light-bg">
                                            ...
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Victor Exrixon</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto"> 12 minutes ago</span> </h6>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3">
                                            ...
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Surfiya Zakir</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto">30 minutes ago</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3">
                                            <img src="https://via.placeholder.com/50x50.png" alt="user" class="w45 me-3">
                                            <i class="feather-thumbs-up text-white bg-primary-gradiant me-2 font-xssss notification-react"></i>
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Goria Coast</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto">1 hours ago</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3">
                                            ...
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Hurin Seary</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto">2 hours ago</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3 bg-lightgreen theme-light-bg">
                                            <img src="https://via.placeholder.com/50x50.png" alt="user" class="w45 me-3">
                                            <i class="feather-message-square text-white bg-mini-gradiant me-2 font-xssss notification-react"></i>
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Victor Exrixon</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto">6 hours ago</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3">
                                            ...
                                            <i class="feather-thumbs-up text-white bg-primary-gradiant me-2 font-xssss notification-react"></i>
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Surfiya Zakir</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 0l-auto">11 hours ago</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3 bg-lightgrey theme-light-bg">
                                            <img src="https://via.placeholder.com/50x50.png" alt="user" class="w45 me-3">
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Goria Coast</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 ms-auto">12:48PM</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3">
                                            <img src="https://via.placeholder.com/50x50.png" alt="user" class="w45 me-3">
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Hurin Seary</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 ms-auto">12:48PM</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3">
                                            <img src="https://via.placeholder.com/50x50.png" alt="user" class="w45 me-3">
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Surfiya Zakir</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 ms-auto"> 12:48PM</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="d-flex align-items-center p-3 rounded-3 bg-lightblue theme-light-bg">
                                            <img src="https://via.placeholder.com/50x50.png" alt="user" class="w45 me-3">
                                            <h6 class="font-xssss text-grey-900 text-grey-900 mb-0 mt-0 fw-500 lh-20"><strong>Victor Exrixon</strong> posted in <strong>UI/UX Community</strong> : âMobile Apps UI Designer is required for Techâ¦â <span class="d-block text-grey-500 font-xssss fw-600 mb-0 mt-0 ms-auto">  12:48PM</span> </h6>
                                            <i class="ti-more-alt text-grey-500 font-xs ms-auto"></i>
                                        </a>
                                    </li>
