...
(
	...
	TM_KIND varchar2(100) NOT NULL,
	TM_COUNT number NOT NULL,
	TM_DATE date DEFAULT SYSDATE NOT NULL,
	U_NO number NOT NULL,
	PRIMARY KEY (TM_NO)
);
...
/*복사하고 erm  수정하세요*/
CREATE SEQUENCE SEQ_CALCNO
NOCYCLE
NOCACHE;

CREATE SEQUENCE SEQ_CALDNO
NOCYCLE
NOCACHE;
...
CREATE SEQUENCE SEQ_DAYROUTINE
NOCYCLE
NOCACHE;

CREATE SEQUENCE SEQ_MESSAGEROOM
NOCYCLE
NOCACHE;
