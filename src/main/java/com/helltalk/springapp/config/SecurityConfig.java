...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.antMatchers("/model/shop-1.do","/model/routine.do","/model/ocr.do","/home.do","/cal/List.do","/chat1.do","/diet/**").hasAnyRole("USER","TN","ADMIN")//유저와 트레이너 권한이 있어야 열람할수 있는 페이지, ROLE_는 반드시 생략.자동으로 추가됨으로
